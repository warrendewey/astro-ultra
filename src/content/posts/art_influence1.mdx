...
<div className="flex justify-center">
  <img src="/public/blog_pics/pieta.jpeg" alt="Pietà" className="multi" />
  <img src="/public/blog_pics/pieta.jpg" alt="My Pietà" className="multi" />
</div>
...
I'm usually not one to watch much tv. In fact, I've only finished a handful of tv series (in fact, maybe only Rick and Morty).
